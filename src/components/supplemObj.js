...
export const SupplemObj = ({ nume, numar_serviri, cantitate, pret, descriere, imgUrl, imgCart, countCart}) => {
    ...
    <Col sm={6} md={4}>
      <div className="suppl-imgbox">
        ...
        <div className="suppl-txtx">
          <h4>{nume}</h4>
          <span><b>Numar serviri: </b>{numar_serviri}</span> <br/>
          <span><b>Pret: {pret} $</b></span> <br/>
          <span>Cantitate: {cantitate}</span> <br/>
