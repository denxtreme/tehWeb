...
export const EquipmObj = ({nume, numar_serviri, cantitate, pret, descriere, imgUrl, imgCart, countCart}) => {
  ...
  function deleteCos() {
    ...
    return (    /* pe ecranele mici ocupam 6 unitati, adica coloana ocupa
                     50% din latimea disponibila*/
                /* pe ecrane medii ocupam 4 unit, adica 33.33%*/
        <Col sm = {6} md = {4}>         
            <div className="suppl-imgbox">
                <img src = {imgUrl} className="imagine"/>
                <div className="suppl-txtx">
                    <h4>{nume}</h4>
                    <span>Pret: {pret} $</span> <br/>
                    <span>{descriere}</span> <br/>
