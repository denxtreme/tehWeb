...
import '../Styling/abonamente.css'

export const AbonObj = ({ nume, numar_serviri, cantitate, pret, descriere, imgUrl, imgCart, countCart}) => {
...
function deleteCos() {
  ...
  return (
    <Col sm={6} md={4}>
      <div className="abon-imgbox">
        <img src={imgUrl} alt={nume} className="imagine"/>
        <div className="abon-txtx">
          <h4>{nume}</h4>
          <span><b>Durata: </b>{numar_serviri}</span> <br/>
          <span><b>Pret: {pret} $</b></span> <br/>
      ...
      <Modal className="modal-obj" show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body className="body-modal">
          <h4>{`Abonamentul ${nume} a fost adăugat în coș.`}</h4>
        </Modal.Body>
